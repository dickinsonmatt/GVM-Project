...
agep_q6 <- engagement_by_age %>% ggplot(aes(x=fct_relevel(gvsu_engagement,"Disagree","Neutral","Agree"), 
                                 y=percent, fill=as.factor(age))) +
  geom_bar(stat = 'identity', position='dodge', color='black') +
...
agep_q8 <- drive_to_website_by_age %>% ggplot(aes(x=drive_to_website, y=percent, fill=as.factor(age))) +
  geom_bar(stat = 'identity', position='dodge', color='black') +
  labs(title = "Driver of Website Visitation by Age (Q8)",
       y = "Percent",
       fill = "Age",
...
agep_q10 <- website_engagement_by_age %>% ggplot(aes(x=website_engagement, y=percent, fill=as.factor(age))) +
  geom_bar(stat = 'identity', position='dodge', color='black') +
...
agep_q12 <- opting_by_age %>% ggplot(aes(x=opting, y=percent, fill=as.factor(age))) +
  geom_bar(stat = 'identity', position='dodge', color='black') +
