...
\NormalTok{where\_read\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{rename}\NormalTok{(where\_read\_by\_age,}\StringTok{\textquotesingle{}age\textquotesingle{}}\OtherTok{=}\StringTok{\textquotesingle{}Var1\textquotesingle{}}\NormalTok{,}
                                      ...
                                      \StringTok{\textquotesingle{}Count\textquotesingle{}}\OtherTok{=}\StringTok{\textquotesingle{}Freq\textquotesingle{}}\NormalTok{)}

\CommentTok{\#defining a function to calculate row percentage of each age group}
\NormalTok{perc\_func}\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mydf,myvar) \{}
\NormalTok{  mydf }\OtherTok{\textless{}{-}}\NormalTok{ mydf }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(age, \{\{myvar\}\}) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{summarize}\NormalTok{(}\AttributeTok{Sum\_Count =} \FunctionTok{sum}\NormalTok{(Count)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{group\_by}\NormalTok{(age) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{percent =}\NormalTok{ Sum\_Count }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(Sum\_Count) }\SpecialCharTok{*} \DecValTok{100}\NormalTok{)}
  \FunctionTok{return}\NormalTok{(mydf)}
\NormalTok{\}}

\CommentTok{\#calculate percentage (each age group sum percentage=100)}
\NormalTok{where\_read\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{perc\_func}\NormalTok{(where\_read\_by\_age,where\_read)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{engagement\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{rename}\NormalTok{(engagement\_by\_age,}\StringTok{\textquotesingle{}age\textquotesingle{}}\OtherTok{=}\StringTok{\textquotesingle{}Var1\textquotesingle{}}\NormalTok{,}
                                      ...
                                      \StringTok{\textquotesingle{}Count\textquotesingle{}}\OtherTok{=}\StringTok{\textquotesingle{}Freq\textquotesingle{}}\NormalTok{) }\CommentTok{\#\%\textgreater{}\% }
                     \CommentTok{\#mutate(percent = (Count/sum(Count))*100)}

\CommentTok{\#calculate percentage (each age group sum percentage=100)}
\NormalTok{engagement\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{perc\_func}\NormalTok{(engagement\_by\_age,gvsu\_engagement)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{drive\_to\_website\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{perc\_func}\NormalTok{(drive\_to\_website\_by\_age,drive\_to\_website)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{website\_engagement\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{perc\_func}\NormalTok{(website\_engagement\_by\_age,website\_engagement)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{opting\_by\_age }\OtherTok{\textless{}{-}} \FunctionTok{perc\_func}\NormalTok{(opting\_by\_age,opting)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{main_code_files/figure-latex/unnamed-chunk-2-1.pdf}
