...
drive_to_website_by_age %>% ggplot(aes(x=drive_to_website, y=percent, fill=age)) +
  geom_bar(stat = 'identity', position='dodge') +
  labs(title = "Most Likley to Drive to Website by Age",
       y = "Percent",
       fill = "Age") +
  theme(axis.title.y = element_blank()) +
  coord_flip() +
...
#Create data frame with the counts of each typ 
website_engagement_by_age <- as.data.frame(table(gvm_clean$age,gvm_clean$website_engagement))
...
opting_by_age %>% ggplot(aes(x=opting, y=percent, fill=age)) +
  geom_bar(stat = 'identity', position='dodge') +
  labs(title = "Opting Status by Age",
       y = "Percent",
       fill = "Age") +
  theme(axis.title.y = element_blank()) +
  coord_flip() +
