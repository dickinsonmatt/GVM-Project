...
def get_qualtrics_survey(dir_save_survey, survey_id):
    ...
    api_token = "q7Ug8Q7q3looFUVKlyarHKLoLAA44X7vJHLqg0c6"
    file_format = "csv"
    data_center = "gvsu.iad1" # "<Organization ID>.<Datacenter ID>"
...
if __name__ == "__main__":
    ...
    path = "C:/Users/goldp/Documents/MyR/GVM-Project"

    get_qualtrics_survey(dir_save_survey = path, survey_id = "SV_3KnxgS4mwd1lxJA")
