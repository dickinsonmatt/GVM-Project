...
Q11_plot_zoom <- Q11_data |>
  filter(action %in% c("Saved Article", "Shared Article - Email", "Shared Article - Social Media", "Visited Website")) |>
  mutate(action = str_replace_all(action, " Article -", " -"),
    action = factor(action, levels = c("Shared - Social Media", "Shared - Email",  "Saved Article", "Visited Website"))
    ) |> 
